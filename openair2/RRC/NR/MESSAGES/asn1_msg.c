 ...
 *bwp_Dedicated->pdsch_Config->choice.setup->prb_BundlingType.choice.staticBundling->bundleSize = NR_PDSCH_Config__prb_BundlingType__staticBundling__bundleSize_wideband;
  ...
  for (int bwp_loop = 0; bwp_loop < n_dl_bwp + 1; bwp_loop++) {

    NR_BWP_Downlink_t *bwp = NULL;
    if (bwp_loop > 0) {
      bwp = SpCellConfig->spCellConfigDedicated->downlinkBWP_ToAddModList->list.array[bwp_loop-1];
    ...
    csires1->csi_ResourceConfigId = bwp_loop+20;
    ...
    *ssbres00 = 0;
    ...
    csires1->bwp_Id = bwp ? bwp->bwp_Id : 0;
    ...
    csires0->csi_ResourceConfigId = bwp_loop;
    ...
    *nzp0 = bwp_loop;
    ...
    csires0->bwp_Id = bwp ? bwp->bwp_Id : 0;
    ...
    ASN_SEQUENCE_ADD(&csi_MeasConfig->csi_ResourceConfigToAddModList->list,csires0);
      ...
      if (pdsch_AntennaPorts > 1) {
        ...
        csires2->csi_ResourceConfigId = bwp_loop+10;
        ...
        *csiim00 = bwp_loop;
        ...
        csires2->bwp_Id = bwp ? bwp->bwp_Id : 0;
      ...
      pucchcsires1->uplinkBandwidthPartId = bwp_loop;
      ...
      if (pdsch_AntennaPorts > 1) {
        ...
        csirep1->resourcesForChannelMeasurement=bwp_loop;
        csirep1->csi_IM_ResourcesForInterference=calloc(1,sizeof(*csirep1->csi_IM_ResourcesForInterference));
        *csirep1->csi_IM_ResourcesForInterference=bwp_loop+10;
        ...
        *csirep1->reportFreqConfiguration->pmi_FormatIndicator=NR_CSI_ReportConfig__reportFreqConfiguration__pmi_FormatIndicator_widebandPMI;
        ...
        if(bwp && bwp->bwp_Dedicated->pdsch_Config->choice.setup->mcs_Table!=NULL)
      ...
      csirep2->reportConfigId=bwp_loop+10;
      csirep2->carrier=NULL;
      csirep2->resourcesForChannelMeasurement=bwp_loop;
